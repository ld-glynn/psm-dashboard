        ...
        .map((theme) => (
          ...
          >
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-xs px-2 py-0.5 rounded-full bg-[var(--text-faint)] text-[var(--text-secondary)]">
                Priority {theme.priority_score.toFixed(1)}
              </span>
            </div>
            <p className="text-sm text-[var(--text-secondary)] mb-3">{theme.summary}</p>
