...
export const statusColor: Record<string, string> = {
  ...
  draft: "bg-orange-100 dark:bg-orange-500/20 text-orange-700 dark:text-orange-300",
...
export const stageColors: Record<string, { bg: string; border: string; text: string; dot: string }> = {
  ...
  drafts: { bg: "bg-orange-50 dark:bg-orange-500/10", border: "border-orange-200 dark:border-orange-500/30 border-dashed", text: "text-orange-600 dark:text-orange-400", dot: "bg-orange-500 dark:bg-orange-400" },
